...
public interface UserDao {
	...
	int updateByOnLine(Map<String, String> map); // 修改当前用户在线状态
	...
	List<Map<String, String>> queryByRoleName(Map<String, String> map); 
	 ...
	 * @return
	 */
	int insertUserLog(Map<String, String> map);
	 ...
	 * @return
	 */
	List<Map<String, String>> queryLogUtil(Map<String, String> map);
	 ...
	 * @return
	 */
	List<Map<String, String>> queryLogLogin(Map<String, String> map);
